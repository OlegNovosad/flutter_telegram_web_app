      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 12),
            OneColorExpandableTile('textColor', mainButton.textColor,
                expanded: true),
            const SizedBox(height: 12),
            InfoExpandableTile('isVisible', mainButton.isVisible.toString(),
                expanded: true),
            const SizedBox(height: 12),
            InfoExpandableTile('isActive', mainButton.isActive.toString(),
                expanded: true),
            const SizedBox(height: 12),
            InfoExpandableTile(
              'isProgressVisible',
